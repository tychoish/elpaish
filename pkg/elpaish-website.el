    ...
    (when-let* ((ver-str (elpaish-recipe-version-for-stream recipe stream)))
      (let* ((name (elpaish-recipe-name recipe))
        ...
        (let* ((toggle-id (format "toggle-%s" name))
               (origin-lbl (elpaish-recipe-origin-label recipe))
               (tag-class (format "pkg-origin-tag pkg-%s-tag%s"
                                  origin-lbl
                                  (if (string= origin-lbl "third-party") " pkg-external-tag" "")))
               (tag-title (cond
                           ((string= origin-lbl "fork") "Fork maintained by Casap / Tycho")
                           ((string= origin-lbl "third-party") "Third-party maintained package")
                           (t "Tychoish maintained package"))))
          (list
           `(tr ((class . "pkg-row"))
                (td ((class . "pkg-name-cell"))
                    ...
                    (label ((for . ,toggle-id) (class . "pkg-toggle-label") (title . "Click to view package details"))
                           ...
                           (b nil ,name)))
                (td ((class . "pkg-origin-cell"))
                    (span ((class . ,tag-class) (title . ,tag-title)) ,origin-lbl))
           ...
           `(tr ((class . "pkg-detail-row"))
                (td ((colspan . "5") (class . "pkg-detail-cell"))
                    (div ((class . "pkg-detail-box"))
                         (div ((class . "detail-list"))
                              (div ((class . "detail-field"))
                                   (strong nil "Source: ")
                                   ,(cond
                                     ((string= origin-lbl "fork") "Forked package")
                                     ((string= origin-lbl "third-party") "Third-party package")
                                     (t "Tychoish native package")))
                              (div ((class . "detail-field"))
    ...
    `(div ((class . "table-wrapper"))
          (table ((id . "pkg-table"))
                 (tr nil
                     ...
                     (th ((class . "pkg-origin-cell")) "Source")
