  ...
  (append
   ...
   `((h1 (border-bottom . ,(format "2px solid %s" (elpaish-css-color 'fg-dim)))
     ...
     (".pkg-name-cell" (width . "260px")
                       (white-space . "nowrap"))
     (".pkg-origin-cell" (width . "100px")
                         (text-align . "center")
                         (white-space . "nowrap"))
     (".pkg-origin-tag" (display . "inline-block")
                        (font-size . "0.75em")
                        (font-weight . "600")
                        (padding . "1px 7px")
                        (border-radius . "4px")
     ...
     (".pkg-fork-tag" (color . ,(elpaish-css-color 'magenta))
                      (background . ,(elpaish-css-color 'bg-dim))
                      (border . ,(format "1px solid %s" (elpaish-css-color 'magenta))))
     (".pkg-third-party-tag" (color . ,(elpaish-css-color 'fg-dim))
                             (background . ,(elpaish-css-color 'bg-dim))
                             (border . ,(format "1px solid %s" (elpaish-css-color 'border))))
     (".pkg-tychoish-tag" (color . ,(elpaish-css-color 'fg-link))
                          (background . ,(elpaish-css-color 'bg-dim))
                          (border . ,(format "1px solid %s" (elpaish-css-color 'fg-link))))
     ...
     ("label.pkg-toggle-label b" (font-weight . "700")
                                 (color . "inherit"))
     (".pkg-external-tag" (font-size . "0.75em")
                          (font-weight . "600")
                          (padding . "1px 6px")
                          (border-radius . "4px")
                          (color . ,(elpaish-css-color 'fg-dim))
